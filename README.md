...
**fleet scorecard** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
Fleet health scorecard — daily scores for all 7 nodes, trend tracking
